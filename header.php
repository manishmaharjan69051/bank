...
<!--(remove-empty-lines-end)-->
	<head>
		...
		<!--(remove-empty-lines-start)-->
		<!-- Demo CSS -->
		<link rel="stylesheet" href="css/demos/demo-shop-12.css">
		<!--(remove-empty-lines-end)-->
						...
						<div class="header-top">
							<div class="container">
											...
											<div class="dropdownmenu-wrapper">
												<ul class="compare-products">
													<li class="product">
														...
														<h4 class="product-name"><a href="demo-shop-12-product-details.html">White top</a></h4>
													</li>
													<li class="product">
														<a href="#" class="btn-remove" title="Remove Product"><i class="fa fa-times"></i></a>
														<h4 class="product-name"><a href="demo-shop-12-product-details.html">Blue Women Shirt</a></h4>
													</li>
												</ul>
								...
								<div class="top-menu-area">
									...
									<ul class="top-menu">
										<li><a href="demo-shop-12-myaccount.html">My Account</a></li>
										<li><a href="#">Daily Deal</a></li>
										<li><a href="#">My Wishlist</a></li>
										<li><a href="demo-shop-12-blog.html">Blog</a></li>
										<li><a href="demo-shop-12-login.html">Log in</a></li>
									</ul>
								</div>
							...
							<div class="header-row">
								<div class="header-column">
									<div class="header-logo">
										<a href="index.php">
											<img alt="Porto" width="268" height="77" src="img/logo_1.png">
										</a>
									</div>
								</div>
								<div class="header-column">
